...
func (h *Handler) CreateIntent(w http.ResponseWriter, r *http.Request) {
	...
	a := &PaymentAttempt{EntityID: entityID, Ref: clientRef, OrgID: in.OrgID,
...
func (h *Handler) StripeWebhook(w http.ResponseWriter, r *http.Request) {
	...
	upd, err := h.deps.Store.SetAttemptStatus(r.Context(), h.deps.DB, entityID, a.ID, to, a.RowVersion)
	if err != nil {
		platform.WriteError(w, err)
		return
	}
