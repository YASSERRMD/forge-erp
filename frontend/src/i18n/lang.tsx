...
const dict = {
  en: {
    ...
    entries: 'Entries',
    language: 'Language',
    postings: 'Auto-postings',
    postingList: 'Posting list',
    chartPack: 'Chart pack',
    loadPack: 'Load pack',
    ...
    queueRecipients: 'Queue recipients',
    ...
    referrals: 'Referrals',
    referrerOrg: 'Referrer org',
    referredOrg: 'Referred org',
    accrue: 'Accrue',
  ...
  fr: {
    ...
    dictList: 'Liste des dictionnaires',
    entries: 'Entrées',
    language: 'Langue',
    postings: 'Écritures auto',
    postingList: 'Liste des écritures',
    chartPack: 'Plan comptable',
    loadPack: 'Charger le plan',
    downloadFEC: 'Télécharger le FEC',
    value: 'Valeur',
    lines: 'Lignes',
    ...
    queueRecipients: 'Mettre en file',
    extraEmails: 'Courriels supplémentaires',
    queue: 'File',
    queued: 'En file',
    sent: 'Envoyé',
    partnerships: 'Partenariats',
    programList: 'Liste des programmes',
    referrals: 'Parrainages',
    referrerOrg: 'Organisation parrain',
    referredOrg: 'Organisation parrainée',
    accrue: 'Comptabiliser',
    saleTotal: 'Total de la vente',
    dataPolicy: 'Données personnelles',
    retentionRules: 'Règles de conservation',
    retainDays: 'Jours de conservation',
    dryRun: 'Simulation',
    erasures: 'Effacements',
